...
export const FIELD_TRANSLATIONS: Record<string, string> = {
  ...
  'implement.leftSideMeasureId': 'medida do lado do motorista',
  'implement.rightSideMeasureId': 'medida do lado do sapo',
  'implement.backSideMeasureId': 'medida da traseira',
  'implement.frontSideMeasureId': 'medida da frente',
  ...
  projectFileIds: 'projetos',
  projectFiles: 'projetos',
  logoPaintIds: 'cores da logomarca',
  logoPaints: 'cores da logomarca',
  airbrushings: 'aerografias',
  serviceOrders: 'ordens de serviço',
  'serviceOrders:PRODUCTION': 'ordem de serviço - produção',
  'serviceOrders:COMMERCIAL': 'ordem de serviço - comercial',
  'serviceOrders:LOGISTIC': 'ordem de serviço - logística',
  'serviceOrders:ARTWORK': 'ordem de serviço - arte',
  implementMeasures: 'medidas',
  rearDoor: 'porta traseira',
  implementProjectFiles: 'projeto do implemento',
  implementLayouts: 'arte do implemento',
