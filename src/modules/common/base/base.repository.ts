...
> {
  ...
  // Create operations
  /**
   * Create a new entity with optional includes for returned data
   * @param data The data to create the entity
   * @param options Optional includes and other creation options
   * @returns The created entity with requested includes
   */
  ...
  /**
   * Create multiple entities with optional includes for returned data
   * @param data Array of data to create entities
   * @param options Optional includes and other creation options
   * @returns Batch result with created entities including requested relations
   */
  abstract createMany(
    data: CreateFormData[],
  ...
  // Read operations
  abstract findById(id: number, options?: CreateOptions<Include>): Promise<Entity | null>;
  ...
  abstract findByIds(ids: number[], options?: CreateOptions<Include>): Promise<Entity[]>;
  ...
  // Update operations
  /**
   * Update an entity with optional includes for returned data
   * @param id The entity ID to update
   * @param data The data to update
   * @param options Optional includes and other update options
   * @returns The updated entity with requested includes
   */
  abstract update(
    id: number,
    data: UpdateFormData,
  ...
  abstract deleteMany(ids: number[]): Promise<BatchDeleteResult>;
