...
export abstract class DiscountRepository {
  ...
  abstract update(id: string, data: DiscountUpdateFormData, tx?: PrismaTransaction): Promise<Discount>;
  ...
  abstract updateOrder(payrollId: string, updates: { id: string; calculationOrder: number }[], tx?: PrismaTransaction): Promise<Discount[]>;
}