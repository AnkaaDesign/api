...
// Dependentes do colaborador — CRUD completo. Base do cálculo de IRRF
// (dedução por dependente) e do salário-família na folha de pagamento.
...
export class DependentController {
  ...
  @WriteRateLimit()
  async batchCreate(
    @Body(new ZodValidationPipe(dependentBatchCreateSchema))
    data: DependentBatchCreateFormData,
    @Query(new ZodQueryValidationPipe(dependentBatchQuerySchema))
    query: DependentBatchQueryFormData,
    @UserId() userId: string,
  ...
  @WriteRateLimit()
  async batchUpdate(
    @Body(new ZodValidationPipe(dependentBatchUpdateSchema))
  ...
  @WriteRateLimit()
  async batchDelete(
    @Body(new ZodValidationPipe(dependentBatchDeleteSchema))
