...
export const REGISTRATION_STATUS_LABELS: Record<REGISTRATION_STATUS, string> = {
  ...
  [REGISTRATION_STATUS.UNFIT]: 'Unfit',
  [REGISTRATION_STATUS.ACTIVE_NOT_REGULAR]: 'Active Not Regular',
  [REGISTRATION_STATUS.DEREGISTERED]: 'Deregistered',
};
...
export const CUT_REQUEST_REASON_LABELS: Record<CUT_REQUEST_REASON, string> = {
  ...
  [CUT_REQUEST_REASON.WRONG]: 'Wrong',
};
...
export const ASSIGNMENT_TYPE_LABELS: Record<ASSIGNMENT_TYPE, string> = {
  ...
  [ASSIGNMENT_TYPE.SPECIFIC]: 'Specific',
};
...
export const PAINT_FINISH_LABELS: Record<PAINT_FINISH, string> = {
  [PAINT_FINISH.SOLID]: 'Solid',
  [PAINT_FINISH.METALLIC]: 'Metallic',
  [PAINT_FINISH.PEARL]: 'Pearl',
  [PAINT_FINISH.MATTE]: 'Matte',
  [PAINT_FINISH.SATIN]: 'Satin',
};

export const PAINT_TYPE_ENUM_LABELS: Record<PAINT_TYPE_ENUM, string> = {
  [PAINT_TYPE_ENUM.POLYESTER]: 'Polyester',
  [PAINT_TYPE_ENUM.ACRYLIC]: 'Acrylic',
  [PAINT_TYPE_ENUM.LACQUER]: 'Lacquer',
  [PAINT_TYPE_ENUM.POLYURETHANE]: 'Polyurethane',
  [PAINT_TYPE_ENUM.EPOXY]: 'Epoxy',
};
...
export const WARNING_SEVERITY_LABELS: Record<WARNING_SEVERITY, string> = {
  ...
  [WARNING_SEVERITY.WRITTEN]: 'Written',
  [WARNING_SEVERITY.SUSPENSION]: 'Suspension',
  [WARNING_SEVERITY.FINAL_WARNING]: 'Final Warning',
};

export const WARNING_CATEGORY_LABELS: Record<WARNING_CATEGORY, string> = {
  [WARNING_CATEGORY.SAFETY]: 'Safety',
  [WARNING_CATEGORY.MISCONDUCT]: 'Misconduct',
  [WARNING_CATEGORY.INSUBORDINATION]: 'Insubordination',
  [WARNING_CATEGORY.POLICY_VIOLATION]: 'Policy Violation',
  [WARNING_CATEGORY.ATTENDANCE]: 'Attendance',
  [WARNING_CATEGORY.PERFORMANCE]: 'Performance',
  [WARNING_CATEGORY.BEHAVIOR]: 'Behavior',
  [WARNING_CATEGORY.OTHER]: 'Other',
};
...
export const COLOR_SCHEMA_LABELS: Record<COLOR_SCHEMA, string> = {
  ...
  [COLOR_SCHEMA.SYSTEM]: 'System',
};

export const VERIFICATION_TYPE_LABELS: Record<VERIFICATION_TYPE, string> = {
  [VERIFICATION_TYPE.EMAIL]: 'E-mail',
  [VERIFICATION_TYPE.PHONE]: 'Phone',
  [VERIFICATION_TYPE.PASSWORD_RESET]: 'Password Reset',
};

export const VERIFICATION_ERROR_CODE_LABELS: Record<VERIFICATION_ERROR_CODE, string> = {
  // Request validation errors
  [VERIFICATION_ERROR_CODE.INVALID_CONTACT]: 'Invalid Contact',
  [VERIFICATION_ERROR_CODE.CONTACT_REQUIRED]: 'Contact Required',
  [VERIFICATION_ERROR_CODE.CODE_REQUIRED]: 'Code Required',
  [VERIFICATION_ERROR_CODE.INVALID_CONTACT_FORMAT]: 'Invalid Contact Format',

  // User-related errors
  [VERIFICATION_ERROR_CODE.USER_NOT_FOUND]: 'User Not Found',
  [VERIFICATION_ERROR_CODE.USER_ALREADY_VERIFIED]: 'User Already Verified',
  [VERIFICATION_ERROR_CODE.USER_INACTIVE]: 'User Inactive',

  // Code validation errors
  [VERIFICATION_ERROR_CODE.INVALID_CODE]: 'Invalid Code',
  [VERIFICATION_ERROR_CODE.CODE_EXPIRED]: 'Code Expired',
  [VERIFICATION_ERROR_CODE.NO_CODE_SENT]: 'No Code Sent',
  [VERIFICATION_ERROR_CODE.CODE_MISMATCH]: 'Code Mismatch',

  // Rate limiting errors
  [VERIFICATION_ERROR_CODE.TOO_MANY_ATTEMPTS]: 'Too Many Attempts',
  [VERIFICATION_ERROR_CODE.TOO_MANY_REQUESTS]: 'Too Many Requests',
  [VERIFICATION_ERROR_CODE.CONTACT_COOLDOWN]: 'Contact Cooldown',
  [VERIFICATION_ERROR_CODE.IP_RATE_LIMITED]: 'IP Rate Limited',
  [VERIFICATION_ERROR_CODE.PROGRESSIVE_DELAY]: 'Progressive Delay',

  // Service errors
  [VERIFICATION_ERROR_CODE.SMS_SEND_FAILED]: 'SMS Send Failed',
  [VERIFICATION_ERROR_CODE.EMAIL_SEND_FAILED]: 'Email Send Failed',
  [VERIFICATION_ERROR_CODE.NOTIFICATION_FAILED]: 'Notification Failed',
  ...
  [VERIFICATION_ERROR_CODE.INTERNAL_ERROR]: 'Internal Error',

  // Security errors
  [VERIFICATION_ERROR_CODE.SUSPICIOUS_ACTIVITY]: 'Suspicious Activity',
  [VERIFICATION_ERROR_CODE.BLOCKED_IP]: 'Blocked IP',
  [VERIFICATION_ERROR_CODE.BLACKLISTED_CONTACT]: 'Blacklisted Contact',
  [VERIFICATION_ERROR_CODE.SECURITY_VIOLATION]: 'Security Violation',
};
...
export const VERIFICATION_ERROR_SEVERITY_LABELS: Record<VERIFICATION_ERROR_SEVERITY, string> = {
  ...
  [VERIFICATION_ERROR_SEVERITY.CRITICAL]: 'Critical',
};

export const VERIFICATION_ERROR_CATEGORY_LABELS: Record<VERIFICATION_ERROR_CATEGORY, string> = {
  [VERIFICATION_ERROR_CATEGORY.VALIDATION]: 'Validation',
  [VERIFICATION_ERROR_CATEGORY.RATE_LIMITING]: 'Rate Limiting',
  [VERIFICATION_ERROR_CATEGORY.AUTHENTICATION]: 'Authentication',
  [VERIFICATION_ERROR_CATEGORY.EXTERNAL_SERVICE]: 'External Service',
  [VERIFICATION_ERROR_CATEGORY.SYSTEM]: 'System',
  [VERIFICATION_ERROR_CATEGORY.SECURITY]: 'Safety',
};

export const HOLIDAY_TYPE_LABELS: Record<HOLIDAY_TYPE, string> = {
  [HOLIDAY_TYPE.NATIONAL]: 'National',
  [HOLIDAY_TYPE.STATE]: 'State',
  [HOLIDAY_TYPE.MUNICIPAL]: 'Municipal',
  [HOLIDAY_TYPE.OPTIONAL]: 'Optional',
};
...
export const MEASURE_TYPE_LABELS: Record<MEASURE_TYPE, string> = {
  ...
  [MEASURE_TYPE.ELECTRICAL]: 'Electrical',
  [MEASURE_TYPE.SIZE]: 'Size',
};
...
export const PRIORITY_TYPE_LABELS: Record<PRIORITY_TYPE, string> = {
  ...
  [PRIORITY_TYPE.CRITICAL]: 'Critical',
};
...
export const EFFORT_LEVEL_LABELS: Record<EFFORT_LEVEL, string> = {
  [EFFORT_LEVEL.LOW]: 'Low',
  [EFFORT_LEVEL.MEDIUM]: 'Medium',
  [EFFORT_LEVEL.HIGH]: 'High',
};
...
export const PPE_SIZE_TYPE_LABELS: Record<PPE_SIZE_TYPE, string> = {
  ...
  [PPE_SIZE_TYPE.SHORT]: 'Bermuda',
  [PPE_SIZE_TYPE.BOOT]: 'Bota',
  [PPE_SIZE_TYPE.GLOVE]: 'Luva',
  [PPE_SIZE_TYPE.MASK]: 'Máscara',
  [PPE_SIZE_TYPE.SLEEVES]: 'Mangas',
  [PPE_SIZE_TYPE.RAIN_BOOTS]: 'Galocha',
...
export const ENTITY_TYPE_LABELS: Record<ENTITY_TYPE, string> = {
  ...
  [ENTITY_TYPE.WAREHOUSE_LOCATION]: 'Localização de Armazenamento',
  ...
  [ENTITY_TYPE.VACATION_GROUP]: 'Férias Coletivas',
  ...
  [ENTITY_TYPE.BANK_TRANSACTION]: 'Transação Bancária',
  [ENTITY_TYPE.RECONCILIATION_MATCH]: 'Conciliação',
  [ENTITY_TYPE.FISCAL_DOCUMENT]: 'Nota Fiscal',
  [ENTITY_TYPE.INSTALLMENT]: 'Parcela a Receber',
  [ENTITY_TYPE.INVOICE]: 'Faturamento',
  [ENTITY_TYPE.BANK_SLIP]: 'Boleto',
  [ENTITY_TYPE.RECURRENT_PAYABLE]: 'Conta Recorrente',
  [ENTITY_TYPE.RECURRENT_PAYABLE_OCCURRENCE]: 'Conta a Pagar',
  [ENTITY_TYPE.AIRBRUSHING_NFSE]: 'NFS-e do Aerografista',
  [ENTITY_TYPE.FISCAL_EMITTER_PROFILE]: 'Perfil Fiscal',
  [ENTITY_TYPE.FISCAL_CERTIFICATE]: 'Certificado Digital',
};
...
export const ACTIVITY_REASON_LABELS: Record<ACTIVITY_REASON, string> = {
  ...
  [ACTIVITY_REASON.EXTERNAL_OPERATION_RETURN]: 'Devolução de Operação Externa',
  [ACTIVITY_REASON.OTHER]: 'Other',
};

export const WORKLOAD_LEVEL_LABELS: Record<WORKLOAD_LEVEL, string> = {
  [WORKLOAD_LEVEL.LOW]: 'Low',
  [WORKLOAD_LEVEL.NORMAL]: 'Normal',
  [WORKLOAD_LEVEL.HIGH]: 'High',
...
export const CHANGE_TRIGGERED_BY_LABELS: Record<CHANGE_TRIGGERED_BY, string> = {
  ...
  [CHANGE_TRIGGERED_BY.SYSTEM]: 'System',
  ...
  [CHANGE_TRIGGERED_BY.EXTERNAL_OPERATION_RETURN]: 'Devolução de Operação Externa',
  ...
  [CHANGE_TRIGGERED_BY.PAINT_FORMULA_COMPONENT_BATCH_CREATE]:
    'Criação em Lote de Componente de Fórmula',
  [CHANGE_TRIGGERED_BY.PAINT_FORMULA_COMPONENT_BATCH_UPDATE]:
    'Atualização em Lote de Componente de Fórmula',
  [CHANGE_TRIGGERED_BY.PAINT_FORMULA_COMPONENT_BATCH_DELETE]:
    'Exclusão em Lote de Componente de Fórmula',
  ...
  [CHANGE_TRIGGERED_BY.ADMIN]: 'Admin',
};
...
export const CHANGE_LOG_ENTITY_TYPE_LABELS: Record<CHANGE_LOG_ENTITY_TYPE, string> = {
  ...
  [CHANGE_LOG_ENTITY_TYPE.FISPQ]: 'FISPQ/FDS',
  ...
  [CHANGE_LOG_ENTITY_TYPE.WAREHOUSE_LOCATION]: 'Localização de Armazenamento',
  ...
  [CHANGE_LOG_ENTITY_TYPE.VACATION_GROUP]: 'Férias Coletivas',
  ...
  [CHANGE_LOG_ENTITY_TYPE.BANK_TRANSACTION]: 'Transação Bancária',
  [CHANGE_LOG_ENTITY_TYPE.RECONCILIATION_MATCH]: 'Conciliação',
  [CHANGE_LOG_ENTITY_TYPE.FISCAL_DOCUMENT]: 'Nota Fiscal',
  [CHANGE_LOG_ENTITY_TYPE.INSTALLMENT]: 'Parcela a Receber',
  [CHANGE_LOG_ENTITY_TYPE.INVOICE]: 'Faturamento',
  [CHANGE_LOG_ENTITY_TYPE.BANK_SLIP]: 'Boleto',
  [CHANGE_LOG_ENTITY_TYPE.RECURRENT_PAYABLE]: 'Conta Recorrente',
  [CHANGE_LOG_ENTITY_TYPE.RECURRENT_PAYABLE_OCCURRENCE]: 'Conta a Pagar',
  [CHANGE_LOG_ENTITY_TYPE.AIRBRUSHING_NFSE]: 'NFS-e do Aerografista',
  [CHANGE_LOG_ENTITY_TYPE.FISCAL_EMITTER_PROFILE]: 'Perfil Fiscal',
  [CHANGE_LOG_ENTITY_TYPE.FISCAL_CERTIFICATE]: 'Certificado Digital',
};
...
export const SMS_VERIFICATION_TYPE_LABELS: Record<SMS_VERIFICATION_TYPE, string> = {
  ...
  [SMS_VERIFICATION_TYPE.PASSWORD_RESET]: 'Password Reset',
...
export const CAPTCHA_REQUIREMENT_LEVEL_LABELS: Record<CAPTCHA_REQUIREMENT_LEVEL, string> = {
  ...
  [CAPTCHA_REQUIREMENT_LEVEL.BASIC]: 'Basic',
...
export const VERIFICATION_ABUSE_LEVEL_LABELS: Record<VERIFICATION_ABUSE_LEVEL, string> = {
  [VERIFICATION_ABUSE_LEVEL.LOW]: 'Low',
  [VERIFICATION_ABUSE_LEVEL.MEDIUM]: 'Medium',
  [VERIFICATION_ABUSE_LEVEL.HIGH]: 'High',
...
export const VERIFICATION_METHOD_LABELS: Record<VERIFICATION_METHOD, string> = {
  ...
  [VERIFICATION_METHOD.PHONE]: 'Phone',
...
export const VERIFICATION_PURPOSE_LABELS: Record<VERIFICATION_PURPOSE, string> = {
  ...
  [VERIFICATION_PURPOSE.PASSWORD_RESET]: 'Password Reset',
...
export const NOTE_CATEGORY_LABELS: Record<NOTE_CATEGORY, string> = {
  ...
  [NOTE_CATEGORY.MAINTENANCE]: 'Maintenance',
  ...
  [NOTE_CATEGORY.SAFETY]: 'Safety',
  [NOTE_CATEGORY.OTHER]: 'Other',
};
...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_LISTAR]: 'Lista de EPIs (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_ENTREGAS_LISTAR]: 'Entregas de EPIs (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_AGENDAMENTOS_LISTAR]: 'Agendamentos de EPIs (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_TAMANHOS_LISTAR]: 'Tamanhos de EPIs',
  ...
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_CADASTRAR]: 'Cadastrar EPI (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_ENTREGAS_CADASTRAR]: 'Cadastrar Entrega de EPI (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_AGENDAMENTOS_CADASTRAR]: 'Cadastrar Agendamento de EPI (RH)',
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_EPI_TAMANHOS_CADASTRAR]: 'Cadastrar Tamanho de EPI',
  ...
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_FERIAS_EDITAR_LOTE]: 'Editar Férias em Lote',
  ...
  [FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_FERIAS_CALENDARIO]: 'Calendário de Férias',
...
export const BONUS_DISCOUNT_REASON_LABELS: Record<BONUS_DISCOUNT_REASON, string> = {
  ...
  [BONUS_DISCOUNT_REASON.OTHER]: 'Other',
};
...
export const GUARANTEE_YEARS_LABELS: Record<number, string> = {
  5: '5 anos',
  10: '10 anos',
  15: '15 anos',
};
...
// Rótulos CLT-corretos. Ver base legal em POSITION_CHANGE_REASON (enums.ts):
// rebaixamento unilateral é ilegal (CF art.7º VI + CLT art.468); expomos apenas
...
// FISPQ / FDS — Safety Data Sheet labels.
export const GHS_PICTOGRAM_LABELS: Record<GHS_PICTOGRAM, string> = {
  [GHS_PICTOGRAM.GHS01_EXPLOSIVE]: 'Explosivo',
  [GHS_PICTOGRAM.GHS02_FLAMMABLE]: 'Inflamável',
  [GHS_PICTOGRAM.GHS03_OXIDIZING]: 'Oxidante',
  [GHS_PICTOGRAM.GHS04_GAS_UNDER_PRESSURE]: 'Gás sob pressão',
  [GHS_PICTOGRAM.GHS05_CORROSIVE]: 'Corrosivo',
  [GHS_PICTOGRAM.GHS06_TOXIC]: 'Tóxico',
  [GHS_PICTOGRAM.GHS07_HARMFUL]: 'Nocivo / irritante',
  [GHS_PICTOGRAM.GHS08_HEALTH_HAZARD]: 'Perigo à saúde',
  [GHS_PICTOGRAM.GHS09_ENVIRONMENTAL]: 'Perigo ao meio ambiente',
};
...
// ============================================================================
// Área Andressa — Phase 1 new labels
// ============================================================================
