...
export const USER_STATUS_LABELS: Record<USER_STATUS, string> = {
  [USER_STATUS.EXPERIENCE_PERIOD_1]: 'Experience Period 1/2 (45 days)',
  [USER_STATUS.EXPERIENCE_PERIOD_2]: 'Experience Period 2/2 (45 days)',
  [USER_STATUS.EFFECTED]: 'Effected',
  [USER_STATUS.DISMISSED]: 'Dismissed',
};
...
export const SERVICE_ORDER_STATUS_LABELS: Record<SERVICE_ORDER_STATUS, string> = {
  ...
  [SERVICE_ORDER_STATUS.IN_PROGRESS]: 'In Progress',
  [SERVICE_ORDER_STATUS.COMPLETED]: 'Completed',
  [SERVICE_ORDER_STATUS.CANCELLED]: 'Cancelled',
};

export const SERVICE_ORDER_TYPE_LABELS: Record<SERVICE_ORDER_TYPE, string> = {
  [SERVICE_ORDER_TYPE.PRODUCTION]: 'Production',
  [SERVICE_ORDER_TYPE.FINANCIAL]: 'Financial',
  [SERVICE_ORDER_TYPE.NEGOTIATION]: 'Negotiation',
  [SERVICE_ORDER_TYPE.ARTWORK]: 'Artwork',
};
...
export const EXTERNAL_WITHDRAWAL_TYPE_LABELS: Record<EXTERNAL_WITHDRAWAL_TYPE, string> = {
  [EXTERNAL_WITHDRAWAL_TYPE.RETURNABLE]: 'Returnable',
  [EXTERNAL_WITHDRAWAL_TYPE.CHARGEABLE]: 'Chargeable',
  [EXTERNAL_WITHDRAWAL_TYPE.COMPLIMENTARY]: 'Complimentary',
};
...
export const EXTERNAL_WITHDRAWAL_STATUS_LABELS: Record<EXTERNAL_WITHDRAWAL_STATUS, string> = {
  ...
  [EXTERNAL_WITHDRAWAL_STATUS.CHARGED]: 'Charged',
...
export const PPE_DELIVERY_STATUS_LABELS: Record<PPE_DELIVERY_STATUS, string> = {
  ...
  [PPE_DELIVERY_STATUS.REPROVED]: 'Reproved',
...
export const NOTIFICATION_TYPE_LABELS: Record<NOTIFICATION_TYPE, string> = {
  ...
  [NOTIFICATION_TYPE.VACATION]: 'Vacation',
  [NOTIFICATION_TYPE.WARNING]: 'Warning',
  [NOTIFICATION_TYPE.STOCK]: 'Stock',
  [NOTIFICATION_TYPE.GENERAL]: 'General',
};

export const NOTIFICATION_ACTION_TYPE_LABELS: Record<NOTIFICATION_ACTION_TYPE, string> = {
  [NOTIFICATION_ACTION_TYPE.VIEW_DETAILS]: 'View Details',
  [NOTIFICATION_ACTION_TYPE.APPROVE_REQUEST]: 'Approve Request',
  [NOTIFICATION_ACTION_TYPE.REJECT_REQUEST]: 'Reject Request',
  [NOTIFICATION_ACTION_TYPE.COMPLETE_TASK]: 'Complete Task',
  [NOTIFICATION_ACTION_TYPE.TASK_CREATED]: 'Task Created',
  [NOTIFICATION_ACTION_TYPE.TASK_UPDATED]: 'Task Updated',
  [NOTIFICATION_ACTION_TYPE.VIEW_ORDER]: 'View Order',
  [NOTIFICATION_ACTION_TYPE.VIEW_REPORT]: 'View Report',
  [NOTIFICATION_ACTION_TYPE.ACKNOWLEDGE]: 'Acknowledge',
  [NOTIFICATION_ACTION_TYPE.DISMISS]: 'Dismiss',
};
...
export const NOTIFICATION_CHANNEL_LABELS: Record<NOTIFICATION_CHANNEL, string> = {
  ...
  [NOTIFICATION_CHANNEL.MOBILE_PUSH]: 'Mobile Push',
  [NOTIFICATION_CHANNEL.DESKTOP_PUSH]: 'Desktop Push',
...
export const SECTOR_PRIVILEGES_LABELS: Record<SECTOR_PRIVILEGES, string> = {
  ...
  [SECTOR_PRIVILEGES.TEAM_LEADER]: 'Team Leader',
...
export const ENTITY_TYPE_LABELS: Record<ENTITY_TYPE, string> = {
  ...
  [ENTITY_TYPE.MAINTENANCE]: 'Maintenance',
...
export const FILE_ENTITY_TYPE_LABELS: Record<FILE_ENTITY_TYPE, string> = {
  ...
  [FILE_ENTITY_TYPE.WARNING]: 'Warning',
...
export const ACTIVITY_REASON_LABELS: Record<ACTIVITY_REASON, string> = {
  ...
  [ACTIVITY_REASON.MAINTENANCE]: 'Maintenance',
...
export const CHANGE_LOG_ENTITY_TYPE_LABELS: Record<CHANGE_LOG_ENTITY_TYPE, string> = {
  ...
  [CHANGE_LOG_ENTITY_TYPE.MAINTENANCE]: 'Maintenance',
  ...
  [CHANGE_LOG_ENTITY_TYPE.ORDER]: 'Order',
  ...
  [CHANGE_LOG_ENTITY_TYPE.WARNING]: 'Warning',
