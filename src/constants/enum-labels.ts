...
export const REGISTRATION_STATUS_LABELS: Record<REGISTRATION_STATUS, string> = {
  [REGISTRATION_STATUS.ATIVA]: "Ativa",
  [REGISTRATION_STATUS.SUSPENSA]: "Suspensa",
  [REGISTRATION_STATUS.INAPTA]: "Inapta",
  [REGISTRATION_STATUS.ATIVA_NAO_REGULAR]: "Ativa Não Regular",
  [REGISTRATION_STATUS.BAIXADA]: "Baixada",
};
...
export const EXTERNAL_WITHDRAWAL_TYPE_LABELS: Record<EXTERNAL_WITHDRAWAL_TYPE, string> = {
  [EXTERNAL_WITHDRAWAL_TYPE.RETURNABLE]: "Devolutivo",
...
export const MEASURE_UNIT_LABELS: Record<MEASURE_UNIT, string> = {
  ...
  // PPE Size units (numeric sizes)
  [MEASURE_UNIT.SIZE_35]: "35",
  [MEASURE_UNIT.SIZE_36]: "36",
  [MEASURE_UNIT.SIZE_37]: "37",
  [MEASURE_UNIT.SIZE_38]: "38",
  [MEASURE_UNIT.SIZE_39]: "39",
  [MEASURE_UNIT.SIZE_40]: "40",
  [MEASURE_UNIT.SIZE_41]: "41",
  [MEASURE_UNIT.SIZE_42]: "42",
  [MEASURE_UNIT.SIZE_43]: "43",
  [MEASURE_UNIT.SIZE_44]: "44",
  [MEASURE_UNIT.SIZE_45]: "45",
