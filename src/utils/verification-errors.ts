...
export const VERIFICATION_ERROR_CONFIG: Record<
  VERIFICATION_ERROR_CODE,
  Omit<VerificationErrorDetails, 'code'>
> = {
  ...
  [VERIFICATION_ERROR_CODE.INVALID_CONTACT]: {
    ...
    userMessage:
      'O contato fornecido não é válido. Verifique se o e-mail ou telefone está correto.',
  ...
  [VERIFICATION_ERROR_CODE.INVALID_CONTACT_FORMAT]: {
    ...
    suggestedActions: [
      'Para e-mail: use o formato exemplo@dominio.com',
      'Para telefone: use o formato +55 11 99999-9999 ou (11) 99999-9999',
    ],
    retryable: true,
  ...
  [VERIFICATION_ERROR_CODE.USER_NOT_FOUND]: {
    ...
    userMessage:
      'Não encontramos uma conta associada a este contato. Verifique se o e-mail ou telefone está correto.',
    technicalMessage: 'User not found for the provided contact',
    suggestedActions: [
      'Verifique se o e-mail ou telefone está correto',
      'Certifique-se de que você já possui uma conta',
  ...
  [VERIFICATION_ERROR_CODE.USER_INACTIVE]: {
    ...
    suggestedActions: [
      ...
      'Forneça seu e-mail ou telefone ao suporte para assistência',
    ],
    retryable: false,
  ...
  [VERIFICATION_ERROR_CODE.INVALID_CODE]: {
    ...
    suggestedActions: [
      ...
      'Certifique-se de usar o código mais recente',
      'Se o código expirou, solicite um novo',
    ],
    retryable: true,
  ...
  [VERIFICATION_ERROR_CODE.CODE_EXPIRED]: {
    ...
    suggestedActions: [
      ...
      'Use o novo código dentro de 10 minutos',
    ],
    retryable: true,
  ...
  [VERIFICATION_ERROR_CODE.NO_CODE_SENT]: {
    ...
    suggestedActions: [
      "Clique em 'Enviar código' primeiro",
      'Aguarde receber o código antes de tentar verificar',
    ],
    retryable: true,
  ...
  [VERIFICATION_ERROR_CODE.CODE_MISMATCH]: {
    ...
    suggestedActions: [
      'Verifique cada dígito do código',
      'Certifique-se de não confundir números similares (0 e O, 1 e l)',
  ...
  [VERIFICATION_ERROR_CODE.TOO_MANY_REQUESTS]: {
    ...
    suggestedActions: [
      'Aguarde alguns minutos antes de solicitar novo código',
      'Use o código mais recente que recebeu',
      'Verifique sua caixa de spam se não recebeu o e-mail',
    ],
    retryable: true,
    retryAfter: 5 * 60 * 1000, // 5 minutes
  ...
  [VERIFICATION_ERROR_CODE.CONTACT_COOLDOWN]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.MEDIUM,
    userMessage:
      'Aguarde um pouco antes de tentar novamente. Isso ajuda a manter sua conta segura.',
    technicalMessage: 'Contact is in cooldown period',
    suggestedActions: [
      'Aguarde o tempo indicado',
      'Use o código que você já recebeu',
      'Verifique se já não recebeu o código por SMS ou e-mail',
    ],
    retryable: true,
  ...
  [VERIFICATION_ERROR_CODE.IP_RATE_LIMITED]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.HIGH,
    userMessage:
      'Muitas tentativas de verificação deste local. Aguarde uma hora antes de tentar novamente.',
  ...
  [VERIFICATION_ERROR_CODE.PROGRESSIVE_DELAY]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.MEDIUM,
    userMessage:
      'Aguarde um momento antes da próxima tentativa. O tempo de espera aumenta a cada tentativa incorreta.',
    technicalMessage: 'Progressive delay in effect',
    suggestedActions: [
      'Aguarde o tempo indicado',
      'Verifique cuidadosamente o código na próxima tentativa',
      'Certifique-se de usar o código mais recente',
    ],
    retryable: true,
    progressiveMessage: 'Aguarde para tentar',
  ...
  [VERIFICATION_ERROR_CODE.SMS_SEND_FAILED]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.HIGH,
    userMessage:
      'Não foi possível enviar o SMS. Tente usar verificação por e-mail ou tente novamente mais tarde.',
  ...
  [VERIFICATION_ERROR_CODE.EMAIL_SEND_FAILED]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.HIGH,
    userMessage:
      'Não foi possível enviar o e-mail. Tente usar verificação por SMS ou tente novamente mais tarde.',
  ...
  [VERIFICATION_ERROR_CODE.NOTIFICATION_FAILED]: {
    ...
    suggestedActions: [
      ...
      'Use um método de verificação alternativo',
  ...
  [VERIFICATION_ERROR_CODE.EXTERNAL_SERVICE_ERROR]: {
    ...
    suggestedActions: [
      'Aguarde alguns minutos e tente novamente',
      'Tente um método de verificação alternativo',
      'Entre em contato com o suporte se o problema persistir',
    ],
    retryable: true,
    retryAfter: 5 * 60 * 1000, // 5 minutes
  ...
  [VERIFICATION_ERROR_CODE.DATABASE_ERROR]: {
    ...
    userMessage:
      'Erro interno do sistema. Nossa equipe foi notificada. Tente novamente em alguns minutos.',
  ...
  [VERIFICATION_ERROR_CODE.INTERNAL_ERROR]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.CRITICAL,
    userMessage:
      'Erro interno do sistema. Nossa equipe foi notificada. Tente novamente mais tarde.',
  ...
  [VERIFICATION_ERROR_CODE.SUSPICIOUS_ACTIVITY]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.CRITICAL,
    userMessage:
      'Atividade suspeita detectada. Por segurança, as verificações foram temporariamente bloqueadas.',
  ...
  [VERIFICATION_ERROR_CODE.BLOCKED_IP]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.CRITICAL,
    userMessage:
      'Seu IP foi temporariamente bloqueado por motivos de segurança. Entre em contato com o suporte.',
  ...
  [VERIFICATION_ERROR_CODE.BLACKLISTED_CONTACT]: {
    ...
    severity: VERIFICATION_ERROR_SEVERITY.HIGH,
    userMessage:
      'Este contato não pode ser usado para verificação. Entre em contato com o suporte.',
    technicalMessage: 'Contact is blacklisted',
    suggestedActions: [
      'Entre em contato com o suporte',
      'Use um e-mail ou telefone diferente',
      'Forneça informações adicionais para verificar sua identidade',
    ],
    retryable: false,
  ...
  [VERIFICATION_ERROR_CODE.SECURITY_VIOLATION]: {
    ...
    suggestedActions: [
      ...
      'Não tente novamente até falar com o suporte',
      'Tenha documentos de identificação em mãos',
    ],
    retryable: false,
 ...
 */
export function getVerificationErrorDetails(
  code: VERIFICATION_ERROR_CODE,
