...
import { parseQueryString } from './common/http/query-string-parser';
...
async function bootstrap() {
  try {
    ...
    // Query string parser (bracket and dot notation, no numeric coercion):
    // see src/common/http/query-string-parser.ts.
