...
-- CreateEnum
CREATE TYPE "PayrollDiscountType" AS ENUM ('INSS', 'IRRF', 'FGTS', 'UNION', 'ALIMONY', 'HEALTH_INSURANCE', 'DENTAL_INSURANCE', 'MEAL_VOUCHER', 'TRANSPORT_VOUCHER', 'LOAN', 'ADVANCE', 'ABSENCE', 'LATE_ARRIVAL', 'GARNISHMENT', 'CUSTOM');
...
CREATE TABLE "PayrollDiscount" (
    ...
    "sourceDiscountId" TEXT,
    "taxYear" INTEGER,
    "taxTableId" TEXT,
    "requiresAuthorization" BOOLEAN NOT NULL DEFAULT false,
    "employeeAuthorizationDate" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "PayrollDiscount_sourceDiscountId_idx" ON "PayrollDiscount"("sourceDiscountId");
...
-- AddForeignKey
ALTER TABLE "PayrollDiscount" ADD CONSTRAINT "PayrollDiscount_sourceDiscountId_fkey" FOREIGN KEY ("sourceDiscountId") REFERENCES "PayrollDiscount"("id") ON DELETE SET NULL ON UPDATE CASCADE;
