...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('PREPARATION', 'WAITING_PRODUCTION', 'IN_PRODUCTION', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ServiceOrderType" AS ENUM ('PRODUCTION', 'FINANCIAL', 'COMMERCIAL', 'ARTWORK', 'LOGISTIC');

-- CreateEnum
CREATE TYPE "ServiceOrderStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'WAITING_APPROVE', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "AirbrushingStatus" AS ENUM ('PENDING', 'IN_PRODUCTION', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ArtworkStatus" AS ENUM ('DRAFT', 'APPROVED', 'REPROVED');
...
-- CreateEnum
CREATE TYPE "BorrowStatus" AS ENUM ('ACTIVE', 'RETURNED', 'LOST', 'OVERDUE');
...
-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('PENDING', 'PROCESSING', 'DELIVERED', 'FAILED', 'RETRYING');
...
-- CreateEnum
CREATE TYPE "TRUCK_SPOT" AS ENUM ('B1_F1_V1', 'B1_F1_V2', 'B1_F1_V3', 'B1_F2_V1', 'B1_F2_V2', 'B1_F2_V3', 'B1_F3_V1', 'B1_F3_V2', 'B1_F3_V3', 'B2_F1_V1', 'B2_F1_V2', 'B2_F1_V3', 'B2_F2_V1', 'B2_F2_V2', 'B2_F2_V3', 'B2_F3_V1', 'B2_F3_V2', 'B2_F3_V3', 'B3_F1_V1', 'B3_F1_V2', 'B3_F1_V3', 'B3_F2_V1', 'B3_F2_V2', 'B3_F2_V3', 'B3_F3_V1', 'B3_F3_V2', 'B3_F3_V3', 'PATIO');
...
-- CreateEnum
CREATE TYPE "TaskPricingStatus" AS ENUM ('DRAFT', 'APPROVED', 'REJECTED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "DiscountType" AS ENUM ('NONE', 'PERCENTAGE', 'FIXED_VALUE');

-- CreateEnum
CREATE TYPE "PaymentCondition" AS ENUM ('CASH', 'INSTALLMENTS_2', 'INSTALLMENTS_3', 'INSTALLMENTS_4', 'INSTALLMENTS_5', 'INSTALLMENTS_6', 'INSTALLMENTS_7', 'CUSTOM');
...
CREATE TABLE "Artwork" (
    ...
    "status" "ArtworkStatus" NOT NULL DEFAULT 'APPROVED',
    "airbrushingId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Task" (
    "id" TEXT NOT NULL,
    "name" TEXT DEFAULT 'Tarefa Sem Nome',
    "status" "TaskStatus" NOT NULL DEFAULT 'PREPARATION',
    "statusOrder" INTEGER NOT NULL DEFAULT 1,
    "serialNumber" TEXT,
    "details" TEXT,
...
CREATE TABLE "TaskFieldChangeLog" (
    ...
    CONSTRAINT "TaskFieldChangeLog_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UserNotificationPreference" (
    ...
    "channels" "NotificationChannel"[],
    "isMandatory" BOOLEAN NOT NULL DEFAULT false,
    "mandatoryChannels" "NotificationChannel"[] DEFAULT ARRAY[]::"NotificationChannel"[],
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Artwork_fileId_idx" ON "Artwork"("fileId");

-- CreateIndex
CREATE INDEX "Artwork_airbrushingId_idx" ON "Artwork"("airbrushingId");
...
-- CreateIndex
CREATE INDEX "ServiceOrder_startedById_idx" ON "ServiceOrder"("startedById");

-- CreateIndex
CREATE INDEX "ServiceOrder_approvedById_idx" ON "ServiceOrder"("approvedById");

-- CreateIndex
CREATE INDEX "ServiceOrder_completedById_idx" ON "ServiceOrder"("completedById");
...
-- CreateIndex
CREATE INDEX "TaskPricing_expiresAt_idx" ON "TaskPricing"("expiresAt");

-- CreateIndex
CREATE INDEX "TaskPricing_layoutFileId_idx" ON "TaskPricing"("layoutFileId");

-- CreateIndex
CREATE INDEX "TaskPricing_customerSignatureId_idx" ON "TaskPricing"("customerSignatureId");

-- CreateIndex
CREATE INDEX "TaskPricingItem_pricingId_idx" ON "TaskPricingItem"("pricingId");
...
-- CreateIndex
CREATE INDEX "Task_forecastDate_idx" ON "Task"("forecastDate");
...
-- CreateIndex
CREATE INDEX "Task_invoiceToId_idx" ON "Task"("invoiceToId");
...
-- CreateIndex
CREATE INDEX "Message_status_statusOrder_idx" ON "Message"("status", "statusOrder");

-- CreateIndex
CREATE INDEX "Message_createdById_idx" ON "Message"("createdById");

-- CreateIndex
CREATE INDEX "Message_startDate_idx" ON "Message"("startDate");

-- CreateIndex
CREATE INDEX "Message_endDate_idx" ON "Message"("endDate");
...
-- CreateIndex
CREATE INDEX "MessageTarget_userId_idx" ON "MessageTarget"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "MessageTarget_messageId_userId_key" ON "MessageTarget"("messageId", "userId");
...
-- CreateIndex
CREATE INDEX "MessageView_viewedAt_idx" ON "MessageView"("viewedAt");
...
-- CreateIndex
CREATE INDEX "_TaskArtworks_B_index" ON "_TaskArtworks"("B");
...
-- AddForeignKey
ALTER TABLE "PpeDelivery" ADD CONSTRAINT "PpeDelivery_ppeScheduleId_fkey" FOREIGN KEY ("ppeScheduleId") REFERENCES "PpeDeliverySchedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PpeDelivery" ADD CONSTRAINT "PpeDelivery_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ExternalWithdrawalItem" ADD CONSTRAINT "ExternalWithdrawalItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MaintenanceItem" ADD CONSTRAINT "MaintenanceItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_invoiceToId_fkey" FOREIGN KEY ("invoiceToId") REFERENCES "Customer"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MessageTarget" ADD CONSTRAINT "MessageTarget_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_TaskArtworks" ADD CONSTRAINT "_TaskArtworks_A_fkey" FOREIGN KEY ("A") REFERENCES "Artwork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TaskArtworks" ADD CONSTRAINT "_TaskArtworks_B_fkey" FOREIGN KEY ("B") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;
