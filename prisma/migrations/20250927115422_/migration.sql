...
-- CreateIndex
CREATE INDEX "Discount_payrollId_idx" ON "public"."Discount"("payrollId");
...
-- AddForeignKey
ALTER TABLE "public"."Discount" ADD CONSTRAINT "Discount_payrollId_fkey" FOREIGN KEY ("payrollId") REFERENCES "public"."Payroll"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
