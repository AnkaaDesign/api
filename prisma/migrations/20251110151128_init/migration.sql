-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('EXPERIENCE_PERIOD_1', 'EXPERIENCE_PERIOD_2', 'CONTRACTED', 'DISMISSED');
...
-- CreateEnum
CREATE TYPE "PaintBaseType" AS ENUM ('TRANSPARENT', 'WHITE', 'ALUMINUM', 'BLACK', 'MIXING');
...
-- CreateEnum
CREATE TYPE "RescheduleReason" AS ENUM ('LOW_FUNDS', 'SUPPLIER_DELAY', 'OPERATIONAL_ISSUE', 'PRIORITY_CHANGE', 'SEASONAL_ADJUSTMENT', 'EMERGENCY', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Task_plate_key" ON "Task"("plate");
...
-- CreateIndex
CREATE INDEX "GarageLane_garageId_idx" ON "GarageLane"("garageId");

-- CreateIndex
CREATE INDEX "ParkingSpot_garageLaneId_idx" ON "ParkingSpot"("garageLaneId");
...
-- AddForeignKey
ALTER TABLE "GarageLane" ADD CONSTRAINT "GarageLane_garageId_fkey" FOREIGN KEY ("garageId") REFERENCES "Garage"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ParkingSpot" ADD CONSTRAINT "ParkingSpot_garageLaneId_fkey" FOREIGN KEY ("garageLaneId") REFERENCES "GarageLane"("id") ON DELETE CASCADE ON UPDATE CASCADE;
