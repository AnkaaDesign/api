...
const CONFIGS: ConfigDef[] = [
  ...
  },
  {
    ...
    description: "Colaborador rejeitou o cartão-ponto do período, com justificativa. (Aguardando integração — poller Secullum ainda não implementado.)",
    enabled: true,
    importance: "URGENT",
    workHoursOnly: false,
    batchingEnabled: false,
  ...
  },
  {
    ...
    description: "Colaborador assinou o cartão-ponto do período. (Aguardando integração — poller Secullum ainda não implementado.)",
    enabled: true,
    importance: "LOW",
    workHoursOnly: false,
    batchingEnabled: false,
