...
echo "   ln -s /etc/nginx/sites-available/ankaa.live.conf /etc/nginx/sites-enabled/"
echo "   ln -s /etc/nginx/sites-available/api.ankaa.live.conf /etc/nginx/sites-enabled/"
echo "   ln -s /etc/nginx/sites-available/webhook.ankaa.live.conf /etc/nginx/sites-enabled/"
echo "   ln -s /etc/nginx/sites-available/arquivos.ankaa.live.conf /etc/nginx/sites-enabled/"
...
echo "  - https://ankaa.live (Web)"
echo "  - https://api.ankaa.live (API)"
echo "  - https://webhook.ankaa.live (Webhooks)"
echo "  - https://arquivos.ankaa.live (Arquivos/Files)"
echo ""
